...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public ExistEmployeeResponseDTO exists(Long employeeId) {
        boolean exists = employeeRepository.exists(employeeId);
        return ExistEmployeeResponseDTO.from(employeeId, exists);
    }
